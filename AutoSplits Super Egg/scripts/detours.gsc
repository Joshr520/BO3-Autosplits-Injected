...
detour scene<scripts\shared\scene_shared.gsc>::play(arg1, arg2, arg3, b_test_run = false, str_state, str_mode = "")
{
    switch(level.script)
    {
        case "zm_stalingrad":
        {
            ...
            if(arg1 == "cin_sta_outro_3rd_sh020")
            {
                compiler::livesplit("split");
        ...
        case "zm_genesis":
        {
            ...
            else if(arg1 == "genesis_ee_sams_room") thread split_on_delay(0.6, 1);
            break;
        }
    }
...
split_on_delay(delay, end_game)
{
    wait delay;
    compiler::livesplit("split");
    if(end_game) compiler::livesplit("pause");
}